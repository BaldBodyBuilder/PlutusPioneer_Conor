...
mint tn = do
    ...
    case Map.keys utxos of
        ...
        oref : _ -> do -- utxo at the head of the list first one doesn't matter
            let val     = Value.singleton (curSymbol oref tn) tn 1 -- value to forge via singleton
...
-- Both end up with a different currency symbol with 1 NFT coin, different NFTs though 