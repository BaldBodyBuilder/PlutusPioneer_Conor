...
-- So far same as even odd
data GameChoice = Rock | Paper | Scissors -- Three options versus two options with E/O
    deriving (Show, Generic, FromJSON, ToJSON, ToSchema, Prelude.Eq, Prelude.Ord)

-- game choice rr pp ss _ _
