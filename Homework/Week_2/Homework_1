...
mkValidator () (boolA, BoolB) _ = traceIfFalse "Wrong Redeemer" $ boolA == boolB

--think of the traceIfFalse to mean, if the following equation evals to false it will then present the error
